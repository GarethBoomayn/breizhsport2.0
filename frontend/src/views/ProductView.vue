...
<template>
  <div class="container mx-auto px-4 py-8">
    <button @click="router.back()" class="mb-6 flex items-center text-blue-600 hover:text-blue-800">
    ...
    <div v-else-if="!product" class="text-center py-10">
      ...
      <router-link to="/" class="text-blue-600 hover:underline mt-2 inline-block">Retour à l'accueil</router-link>
    </div>
    ...
    <div v-else class="bg-white rounded-lg shadow-lg overflow-hidden">
      <div class="md:flex">
        ...
        <div class="md:w-1/2 p-6">
          <div class="mb-2">
            <span v-if="product.category" class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded">
          ...
          <div class="mb-6">
            <p class="text-sm text-gray-600 mb-1">
              Disponibilité: 
              <span v-if="product.stock > 0" class="text-green-600 font-semibold">En stock ({{ product.stock }})</span>
          ...
          <div v-if="product.stock > 0" class="mb-6">
            ...
            <div class="flex items-center">
              ...
              <input 
                ...
                min="1" 
                :max="product.stock" 
                class="w-16 text-center border-gray-300 focus:ring-blue-500 focus:border-blue-500 block"
              >
              <button 
